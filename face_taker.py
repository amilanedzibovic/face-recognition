...
if __name__ == '__main__':
    ...
    directory = 'datasets/new_persons/' + face_name
    ...
    while True:
        ...
        faces = faceCascade.detectMultiScale(color, scaleFactor=1.3, minNeighbors=5)
        ...
        for (x, y, w, h) in faces:
            ...
            cv2.imwrite(f'./datasets/new_persons/{face_name}/{count}.jpg', color[y:y+h, x:x+w])
